...
{
	literals["__except"] = 89;
	literals["_cdecl"] = 143;
	literals["__stdcall"] = 154;
	literals["extern"] = 13;
	literals["public"] = 63;
	...
	literals["__try"] = 88;
	literals["_int32"] = 48;
	literals["__pascal"] = 152;
	literals["template"] = 4;
	literals["reinterpret_cast"] = 127;
	literals["inline"] = 12;
	...
	literals["class"] = 25;
	literals["_stdcall"] = 153;
	literals["friend"] = 21;
	literals["do"] = 82;
	literals["__interrupt"] = 149;
	literals["_far"] = 147;
	literals["typeid"] = 68;
	literals["__alignof__"] = 123;
	literals["__cdecl"] = 144;
	literals["_int64"] = 50;
	literals["pascal"] = 150;
	literals["typedef"] = 7;
	literals["const_cast"] = 128;
...
#line 2876 "CPP_parser.g"
			newline();
#line 1154 "CPPLexer.cpp"
		}
		break;
	}
	case 0x5c /* '\\' */ :
...
#line 1183 "CPPLexer.cpp"
	...
	if ( inputState->guessing==0 ) {
#line 2884 "CPP_parser.g"
		_ttype = ANTLR_USE_NAMESPACE(antlr)Token::SKIP;
#line 1196 "CPPLexer.cpp"
	}
	if ( _createToken && _token==ANTLR_USE_NAMESPACE(antlr)nullToken && _ttype!=ANTLR_USE_NAMESPACE(antlr)Token::SKIP ) {
	   _token = makeToken(_ttype);
	   _token->setText(text.substr(_begin, text.length()-_begin));
...
void CPPLexer::mSpace(bool _createToken) {
	...
	case 0x9 /* '\t' */ :
	{
		match('\t' /* charlit */ );
		if ( inputState->guessing==0 ) {
#line 2928 "CPP_parser.g"
			tab();
#line 1224 "CPPLexer.cpp"
		}
		break;
	}
	case 0xc /* '\14' */ :
...
void CPPLexer::mComment(bool _createToken) {
	...
	for (;;) {
		if (((LA(1) == 0x2a /* '*' */ ) && ((LA(2) >= 0x0 /* '\0' */  && LA(2) <= 0xff)) && ((LA(3) >= 0x0 /* '\0' */  && LA(3) <= 0xff)))&&(LA(2) != '/')) {
			...
			mEndOfLine(false);
			if ( inputState->guessing==0 ) {
#line 2891 "CPP_parser.g"
				deferredNewline();
#line 1263 "CPPLexer.cpp"
			}
		}
...
void CPPLexer::mPREPROC_DIRECTIVE(bool _createToken) {
	...
	if ( inputState->guessing==0 ) {
#line 2907 "CPP_parser.g"
		_ttype = ANTLR_USE_NAMESPACE(antlr)Token::SKIP; newline();
#line 1364 "CPPLexer.cpp"
	}
	if ( _createToken && _token==ANTLR_USE_NAMESPACE(antlr)nullToken && _ttype!=ANTLR_USE_NAMESPACE(antlr)Token::SKIP ) {
	   _token = makeToken(_ttype);
	   _token->setText(text.substr(_begin, text.length()-_begin));
...
void CPPLexer::mLineDirective(bool _createToken) {
	...
	for (;;) {
		if ((LA(1) == 0x9 /* '\t' */  || LA(1) == 0xc /* '\14' */  || LA(1) == 0x20 /* ' ' */ )) {
			...
			if ( _cnt686>=1 ) { goto _loop686; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
		}
	...
	for (;;) {
		if ((LA(1) == 0x9 /* '\t' */  || LA(1) == 0xc /* '\14' */  || LA(1) == 0x20 /* ' ' */ )) {
			...
			if ( _cnt688>=1 ) { goto _loop688; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
		}
		...
		if ((LA(1) == 0x9 /* '\t' */  || LA(1) == 0xc /* '\14' */  || LA(1) == 0x20 /* ' ' */ )) {
			...
			for (;;) {
				if ((LA(1) == 0x9 /* '\t' */  || LA(1) == 0xc /* '\14' */  || LA(1) == 0x20 /* ' ' */ )) {
					...
					if ( _cnt692>=1 ) { goto _loop692; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
				}
...
void CPPLexer::mPragma(bool _createToken) {
	...
	if ( inputState->guessing==0 ) {
#line 2937 "CPP_parser.g"
		_ttype = ANTLR_USE_NAMESPACE(antlr)Token::SKIP; newline();
#line 1584 "CPPLexer.cpp"
	}
	if ( _createToken && _token==ANTLR_USE_NAMESPACE(antlr)nullToken && _ttype!=ANTLR_USE_NAMESPACE(antlr)Token::SKIP ) {
	   _token = makeToken(_ttype);
	   _token->setText(text.substr(_begin, text.length()-_begin));
...
void CPPLexer::mEndOfContinuedLine(bool _createToken) {
	...
	if ( inputState->guessing==0 ) {
#line 2996 "CPP_parser.g"
		deferredNewline();
#line 1621 "CPPLexer.cpp"
	}
	if ( _createToken && _token==ANTLR_USE_NAMESPACE(antlr)nullToken && _ttype!=ANTLR_USE_NAMESPACE(antlr)Token::SKIP ) {
	   _token = makeToken(_ttype);
	   _token->setText(text.substr(_begin, text.length()-_begin));
...
void CPPLexer::mError(bool _createToken) {
	...
	if ( inputState->guessing==0 ) {
#line 2946 "CPP_parser.g"
		_ttype = ANTLR_USE_NAMESPACE(antlr)Token::SKIP; newline();
#line 1677 "CPPLexer.cpp"
	}
	if ( _createToken && _token==ANTLR_USE_NAMESPACE(antlr)nullToken && _ttype!=ANTLR_USE_NAMESPACE(antlr)Token::SKIP ) {
	   _token = makeToken(_ttype);
	   _token->setText(text.substr(_begin, text.length()-_begin));
	...
	case 0x78 /* 'x' */ :
	{
		...
		for (;;) {
			if ((_tokenSet_8.member(LA(1))) && (_tokenSet_4.member(LA(2))) && (true)) {
				...
				if ( _cnt731>=1 ) { goto _loop731; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
...
void CPPLexer::mExponent(bool _createToken) {
	...
	for (;;) {
		if (((LA(1) >= 0x30 /* '0' */  && LA(1) <= 0x39 /* '9' */ ))) {
			...
			if ( _cnt743>=1 ) { goto _loop743; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
		}
		...
		try {
			...
			for (;;) {
				if (((LA(1) >= 0x30 /* '0' */  && LA(1) <= 0x39 /* '9' */ ))) {
					...
					if ( _cnt752>=1 ) { goto _loop752; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
				}
	...
	if ( synPredMatched754 ) {
		...
		for (;;) {
			if (((LA(1) >= 0x30 /* '0' */  && LA(1) <= 0x39 /* '9' */ ))) {
				...
				if ( _cnt756>=1 ) { goto _loop756; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
		...
		case 0x2e /* '.' */ :
		{
			...
			if ( inputState->guessing==0 ) {
#line 3117 "CPP_parser.g"
				_ttype = FLOATONE;
#line 2287 "CPPLexer.cpp"
			}
			break;
		}
		case 0x45 /* 'E' */ :
		case 0x65 /* 'e' */ :
		{
			mExponent(false);
			if ( inputState->guessing==0 ) {
#line 3118 "CPP_parser.g"
				_ttype = FLOATTWO;
#line 2298 "CPPLexer.cpp"
			}
			break;
		}
		default:
		...
		if ( synPredMatched763 ) {
			match("...");
			if ( inputState->guessing==0 ) {
#line 3124 "CPP_parser.g"
				_ttype = ELLIPSIS;
#line 2350 "CPPLexer.cpp"
			}
		}
			...
			for (;;) {
				if ((_tokenSet_8.member(LA(1)))) {
					...
					if ( _cnt779>=1 ) { goto _loop779; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
				}
			...
			if ( inputState->guessing==0 ) {
#line 3148 "CPP_parser.g"
				_ttype = HEXADECIMALINT;
#line 2413 "CPPLexer.cpp"
			}
		}
		else if ((LA(1) == 0x2e /* '.' */ ) && (true)) {
			match('.' /* charlit */ );
			if ( inputState->guessing==0 ) {
#line 3126 "CPP_parser.g"
				_ttype = DOT;
			...
			if (((LA(1) >= 0x30 /* '0' */  && LA(1) <= 0x39 /* '9' */ ))) {
				...
				for (;;) {
					if (((LA(1) >= 0x30 /* '0' */  && LA(1) <= 0x39 /* '9' */ ))) {
						...
						if ( _cnt766>=1 ) { goto _loop766; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
					}
				...
				if ( inputState->guessing==0 ) {
#line 3127 "CPP_parser.g"
					_ttype = FLOATONE;
#line 2450 "CPPLexer.cpp"
				}
				{
				switch ( LA(1)) {
				case 0x46 /* 'F' */ :
			...
			if ( inputState->guessing==0 ) {
#line 3137 "CPP_parser.g"
				_ttype = OCTALINT;
#line 2517 "CPPLexer.cpp"
			}
		}
			...
			if ( inputState->guessing==0 ) {
#line 3142 "CPP_parser.g"
				_ttype = DECIMALINT;
#line 2560 "CPPLexer.cpp"
			}
		}
	else {
		throw ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());
	...
	if ( synPredMatched785 ) {
		...
		for (;;) {
			...
			case 0xd /* '\r' */ :
			{
				mEndOfLine(false);
				if ( inputState->guessing==0 ) {
#line 3157 "CPP_parser.g"
					deferredNewline();
#line 2638 "CPPLexer.cpp"
				}
				break;
			}
			case 0x9 /* '\t' */ :
			...
			default:
			{
				if ( _cnt788>=1 ) { goto _loop788; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
			}
			_cnt788++;
		}
		...
		case 0x28 /* '(' */ :
		{
			...
			for (;;) {
				if ((LA(1) == 0xa /* '\n' */  || LA(1) == 0xd /* '\r' */ )) {
					mEndOfLine(false);
					if ( inputState->guessing==0 ) {
#line 3162 "CPP_parser.g"
						deferredNewline();
#line 2670 "CPPLexer.cpp"
					}
				}
			...
			mRPAREN(false);
			if ( inputState->guessing==0 ) {
#line 3165 "CPP_parser.g"
				_ttype = ANTLR_USE_NAMESPACE(antlr)Token::SKIP;
#line 2689 "CPPLexer.cpp"
			}
			break;
		}
		case 0x7b /* '{' */ :
		{
			...
			for (;;) {
				if ((LA(1) == 0xa /* '\n' */  || LA(1) == 0xd /* '\r' */ )) {
					mEndOfLine(false);
					if ( inputState->guessing==0 ) {
#line 3168 "CPP_parser.g"
						deferredNewline();
#line 2703 "CPPLexer.cpp"
					}
				}
			...
			mRCURLY(false);
			if ( inputState->guessing==0 ) {
#line 3171 "CPP_parser.g"
				_ttype = ANTLR_USE_NAMESPACE(antlr)Token::SKIP;
#line 2722 "CPPLexer.cpp"
			}
			break;
		}
		default:
			if ((_tokenSet_12.member(LA(1)))) {
				...
				if ((LA(1) == 0xa /* '\n' */  || LA(1) == 0xd /* '\r' */ )) {
					mEndOfLine(false);
					if ( inputState->guessing==0 ) {
#line 3175 "CPP_parser.g"
						newline();
#line 2753 "CPPLexer.cpp"
					}
				}
				else {
				}
				...
				if ( inputState->guessing==0 ) {
#line 3176 "CPP_parser.g"
					_ttype = ANTLR_USE_NAMESPACE(antlr)Token::SKIP;
#line 2763 "CPPLexer.cpp"
				}
			}
		else {
			throw ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());
